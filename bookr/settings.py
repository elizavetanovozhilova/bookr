...
SECRET_KEY = 'django-insecure-791a7#__m1)!bw4#t5=(fdcg(h%ivt@=7cfi$9vrjie@3=1^8o'
...
'''DATABASES = {
    'default': {
'ENGINE': 'django.db.backends.postgresql', 'NAME': 'bookr',
'USER': <имя пользователя>,
'PASSWORD': <пароль>, 'HOST': <хост-IP-адрес>, 'PORT':
'5432',}}'''
